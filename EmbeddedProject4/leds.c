...
boolean Led1_Get()
{
	return Pin_IsLow(&leds[led_0].pin);
}
...
boolean Led2_Get()
{
	return Pin_IsLow(&leds[led_1].pin);
}
...
boolean Led3_Get()
{
	return Pin_IsLow(&leds[led_2].pin);
}
...
boolean Led4_Get()
{
	return Pin_IsLow(&leds[led_3].pin);
}
